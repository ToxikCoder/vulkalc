...
program , GLenum pname, GLint * params ) ;
GL_APICALL void GL_APIENTRY
...
shader , GLenum pname, GLint * params ) ;
GL_APICALL void GL_APIENTRY
...
program , GLint location, GLfloat * params ) ;
GL_APICALL void GL_APIENTRY
glGetUniformiv (GLuint
program , GLint location, GLint * params ) ;
GL_APICALL GLint
