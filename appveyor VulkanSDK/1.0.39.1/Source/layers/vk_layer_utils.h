...
format ) ;
VK_LAYER_EXPORT unsigned int vk_format_get_channel_count(VkFormat
format ) ;
...
dividend , VkDeviceSize divisor ) ;
VK_LAYER_EXPORT VkStringErrorFlags
vk_string_validate(const int max_length, const char* char_array);
