...
// declare only
    ...
    VKAPI_ATTR VkResult
    VKAPI_CALL EnumeratePhysicalDevices(
            VkInstance
    instance,
...
startWriteObject(my_data, pAllocateInfo
->descriptorPool);
...
finishWriteObject(my_data, pAllocateInfo
->descriptorPool);
// Host access to pAllocateInfo::descriptorPool must be externally synchronized
} else {
finishMultiThread();
...
index++) {
startWriteObject(my_data, pDescriptorWrites[index]
.dstSet);
}
for (
uint32_t index = 0;
index<descriptorCopyCount;
index++) {
startWriteObject(my_data, pDescriptorCopies[index]
.dstSet);
}
...
index<descriptorWriteCount;
index++) {
finishWriteObject(my_data, pDescriptorWrites[index]
.dstSet);
}
for (
uint32_t index = 0;
index<descriptorCopyCount;
index++) {
finishWriteObject(my_data, pDescriptorCopies[index]
.dstSet);
}
// Host access to pDescriptorWrites[].dstSet must be externally synchronized
// Host access to pDescriptorCopies[].dstSet must be externally synchronized
...
// TODO - not wrapping KHR function vkGetPhysicalDeviceFeatures2KHR
// TODO - not wrapping KHR function vkGetPhysicalDeviceProperties2KHR
// TODO - not wrapping KHR function vkGetPhysicalDeviceFormatProperties2KHR
// TODO - not wrapping KHR function vkGetPhysicalDeviceImageFormatProperties2KHR
// TODO - not wrapping KHR function vkGetPhysicalDeviceQueueFamilyProperties2KHR
// TODO - not wrapping KHR function vkGetPhysicalDeviceMemoryProperties2KHR
// TODO - not wrapping KHR function vkGetPhysicalDeviceSparseImageFormatProperties2KHR


// TODO - not wrapping KHR function vkTrimCommandPoolKHR


// declare only
VKAPI_ATTR VkResult

VKAPI_CALL CreateDebugReportCallbackEXT(
        VkInstance instance,
...
// TODO - not wrapping NN function vkCreateViSurfaceNN
