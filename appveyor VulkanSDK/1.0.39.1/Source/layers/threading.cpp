...
namespace threading
{
    ...
    VKAPI_CALL
    CreateInstance(const VkInstanceCreateInfo* pCreateInfo, const VkAllocationCallbacks* pAllocator,
...
VKAPI_CALL EnumerateDeviceExtensionProperties(VkPhysicalDevice physicalDevice,
...
VKAPI_ATTR VkResult
VKAPI_CALL
        CreateDebugReportCallbackEXT(VkInstance
instance,
...
command_pool_map[pCommandBuffers[index]] = pAllocateInfo->
commandPool;
}
}
...
*pMsgCallback) {
return
threading::CreateDebugReportCallbackEXT(instance, pCreateInfo, pAllocator, pMsgCallback
);
}
...
return
threading::EnumerateInstanceLayerProperties(pCount, pProperties
);
}
...
== VK_NULL_HANDLE);
return
threading::EnumerateDeviceLayerProperties(VK_NULL_HANDLE, pCount, pProperties
);
}
...
== VK_NULL_HANDLE);
return
threading::EnumerateDeviceExtensionProperties(VK_NULL_HANDLE, pLayerName, pCount, pProperties
);
}
...
return
threading::GetDeviceProcAddr(dev, funcName
);
}
...
return
threading::GetInstanceProcAddr(instance, funcName
);
}
...
return
threading::GetPhysicalDeviceProcAddr(instance, funcName
);
}
