...
inline void dump_vkGetPhysicalDeviceImageFormatProperties(ApiDumpInstance& dump_inst, VkResult result,
                                                          ...
                                                          VkImageFormatProperties* pImageFormatProperties)
{
    ...
    switch(dump_inst.settings().format())
    {
        case ApiDumpFormat::Text:
            dump_text_vkGetPhysicalDeviceImageFormatProperties(dump_inst, result, physicalDevice, format, type, tiling,
...
inline void
dump_vkEnumerateDeviceExtensionProperties(ApiDumpInstance& dump_inst, VkResult result, VkPhysicalDevice physicalDevice,
                                          ...
                                          VkExtensionProperties* pProperties)
{
    ...
    {
        case ApiDumpFormat::Text:
            dump_text_vkEnumerateDeviceExtensionProperties(dump_inst, result, physicalDevice, pLayerName,
...
inline void
dump_vkEnumerateInstanceExtensionProperties(ApiDumpInstance& dump_inst, VkResult result, const char* pLayerName,
                                            uint32_t* pPropertyCount, VkExtensionProperties* pProperties)
{
    ...
    {
        case ApiDumpFormat::Text:
            dump_text_vkEnumerateInstanceExtensionProperties(dump_inst, result, pLayerName, pPropertyCount,
                                                             pProperties);
            break;
    }
    loader_platform_thread_unlock_mutex(dump_inst.outputMutex());
...
inline void
dump_vkEnumerateInstanceLayerProperties(ApiDumpInstance& dump_inst, VkResult result, uint32_t* pPropertyCount,
...
inline void dump_vkCreateDescriptorSetLayout(ApiDumpInstance& dump_inst, VkResult result, VkDevice device,
...
inline void dump_vkCreateComputePipelines(ApiDumpInstance& dump_inst, VkResult result, VkDevice device,
                                          ...
                                          const VkAllocationCallbacks* pAllocator, VkPipeline* pPipelines)
{
    ...
    {
        case ApiDumpFormat::Text:
            dump_text_vkCreateComputePipelines(dump_inst, result, device, pipelineCache, createInfoCount, pCreateInfos,
...
inline void
dump_vkEnumerateDeviceLayerProperties(ApiDumpInstance& dump_inst, VkResult result, VkPhysicalDevice physicalDevice,
...
inline void dump_vkCreateRenderPass(ApiDumpInstance& dump_inst, VkResult result, VkDevice device,
...
inline void dump_vkQueueSubmit(ApiDumpInstance& dump_inst, VkResult result, VkQueue queue, uint32_t submitCount,
...
inline void dump_vkCreatePipelineLayout(ApiDumpInstance& dump_inst, VkResult result, VkDevice device,
...
inline void dump_vkGetInstanceProcAddr(ApiDumpInstance& dump_inst, PFN_vkVoidFunction result, VkInstance instance,
                                       const char* pName)
{
    loader_platform_thread_lock_mutex(dump_inst.outputMutex());
    switch(dump_inst.settings().format())
...
inline void dump_vkAllocateMemory(ApiDumpInstance& dump_inst, VkResult result, VkDevice device,
                                  const VkMemoryAllocateInfo* pAllocateInfo, const VkAllocationCallbacks* pAllocator,
...
inline void dump_vkCreateSampler(ApiDumpInstance& dump_inst, VkResult result, VkDevice device,
                                 const VkSamplerCreateInfo* pCreateInfo, const VkAllocationCallbacks* pAllocator,
                                 VkSampler* pSampler)
{
    loader_platform_thread_lock_mutex(dump_inst.outputMutex());
    switch(dump_inst.settings().format())
...
inline void
dump_vkGetDeviceProcAddr(ApiDumpInstance& dump_inst, PFN_vkVoidFunction result, VkDevice device, const char* pName)
{
    loader_platform_thread_lock_mutex(dump_inst.outputMutex());
    switch(dump_inst.settings().format())
    {
...
inline void dump_vkCreateDevice(ApiDumpInstance& dump_inst, VkResult result, VkPhysicalDevice physicalDevice,
...
inline void dump_vkMapMemory(ApiDumpInstance& dump_inst, VkResult result, VkDevice device, VkDeviceMemory memory,
...
inline void dump_vkCreateCommandPool(ApiDumpInstance& dump_inst, VkResult result, VkDevice device,
...
inline void
dump_vkFlushMappedMemoryRanges(ApiDumpInstance& dump_inst, VkResult result, VkDevice device, uint32_t memoryRangeCount,
...
inline void dump_vkInvalidateMappedMemoryRanges(ApiDumpInstance& dump_inst, VkResult result, VkDevice device,
...
inline void
dump_vkCreateBuffer(ApiDumpInstance& dump_inst, VkResult result, VkDevice device, const VkBufferCreateInfo* pCreateInfo,
...
inline void dump_vkGetPhysicalDeviceImageFormatProperties2KHR(ApiDumpInstance& dump_inst, VkResult result,
                                                              ...
                                                              VkImageFormatProperties2KHR* pImageFormatProperties)
{
    ...
    {
        case ApiDumpFormat::Text:
            dump_text_vkGetPhysicalDeviceImageFormatProperties2KHR(dump_inst, result, physicalDevice, pImageFormatInfo,
...
inline void dump_vkGetPhysicalDeviceDisplayPropertiesKHR(ApiDumpInstance& dump_inst, VkResult result,
                                                         ...
                                                         VkDisplayPropertiesKHR* pProperties)
{
    ...
    {
        case ApiDumpFormat::Text:
            dump_text_vkGetPhysicalDeviceDisplayPropertiesKHR(dump_inst, result, physicalDevice, pPropertyCount,
                                                              pProperties);
            break;
    }
    loader_platform_thread_unlock_mutex(dump_inst.outputMutex());
...
inline void dump_vkGetPhysicalDeviceSurfaceCapabilities2EXT(ApiDumpInstance& dump_inst, VkResult result,
                                                            ...
                                                            VkSurfaceCapabilities2EXT* pSurfaceCapabilities)
{
    ...
    {
        case ApiDumpFormat::Text:
            dump_text_vkGetPhysicalDeviceSurfaceCapabilities2EXT(dump_inst, result, physicalDevice, surface,
...
inline void
dump_vkResetCommandPool(ApiDumpInstance& dump_inst, VkResult result, VkDevice device, VkCommandPool commandPool,
...
inline void dump_vkBindBufferMemory(ApiDumpInstance& dump_inst, VkResult result, VkDevice device, VkBuffer buffer,
...
inline void dump_vkAllocateCommandBuffers(ApiDumpInstance& dump_inst, VkResult result, VkDevice device,
...
inline void dump_vkBindImageMemory(ApiDumpInstance& dump_inst, VkResult result, VkDevice device, VkImage image,
                                   VkDeviceMemory memory, VkDeviceSize memoryOffset)
{
    loader_platform_thread_lock_mutex(dump_inst.outputMutex());
    switch(dump_inst.settings().format())
...
inline void dump_vkCreateDescriptorPool(ApiDumpInstance& dump_inst, VkResult result, VkDevice device,
...
inline void
dump_vkGetSwapchainImagesKHR(ApiDumpInstance& dump_inst, VkResult result, VkDevice device, VkSwapchainKHR swapchain,
                             uint32_t* pSwapchainImageCount, VkImage* pSwapchainImages)
{
    ...
    {
        case ApiDumpFormat::Text:
            dump_text_vkGetSwapchainImagesKHR(dump_inst, result, device, swapchain, pSwapchainImageCount,
                                              pSwapchainImages);
            break;
    }
    loader_platform_thread_unlock_mutex(dump_inst.outputMutex());
...
inline void
dump_vkAcquireNextImageKHR(ApiDumpInstance& dump_inst, VkResult result, VkDevice device, VkSwapchainKHR swapchain,
                           uint64_t timeout, VkSemaphore semaphore, VkFence fence, uint32_t* pImageIndex)
{
    ...
    {
        case ApiDumpFormat::Text:
            dump_text_vkAcquireNextImageKHR(dump_inst, result, device, swapchain, timeout, semaphore, fence,
                                            pImageIndex);
            break;
    }
    loader_platform_thread_unlock_mutex(dump_inst.outputMutex());
...
inline void dump_vkResetFences(ApiDumpInstance& dump_inst, VkResult result, VkDevice device, uint32_t fenceCount,
...
inline void dump_vkGetPhysicalDeviceDisplayPlanePropertiesKHR(ApiDumpInstance& dump_inst, VkResult result,
                                                              VkPhysicalDevice physicalDevice, uint32_t* pPropertyCount,
                                                              VkDisplayPlanePropertiesKHR* pProperties)
{
    ...
    {
        case ApiDumpFormat::Text:
            dump_text_vkGetPhysicalDeviceDisplayPlanePropertiesKHR(dump_inst, result, physicalDevice, pPropertyCount,
                                                                   pProperties);
            break;
    }
    loader_platform_thread_unlock_mutex(dump_inst.outputMutex());
...
inline void
dump_vkGetDisplayPlaneSupportedDisplaysKHR(ApiDumpInstance& dump_inst, VkResult result, VkPhysicalDevice physicalDevice,
                                           uint32_t planeIndex, uint32_t* pDisplayCount, VkDisplayKHR* pDisplays)
{
    ...
    {
        case ApiDumpFormat::Text:
            dump_text_vkGetDisplayPlaneSupportedDisplaysKHR(dump_inst, result, physicalDevice, planeIndex,
...
inline void dump_vkBeginCommandBuffer(ApiDumpInstance& dump_inst, VkResult result, VkCommandBuffer commandBuffer,
...
inline void dump_vkWaitForFences(ApiDumpInstance& dump_inst, VkResult result, VkDevice device, uint32_t fenceCount,
...
inline void
dump_vkGetDisplayModePropertiesKHR(ApiDumpInstance& dump_inst, VkResult result, VkPhysicalDevice physicalDevice,
                                   ...
                                   VkDisplayModePropertiesKHR* pProperties)
{
    ...
    {
        case ApiDumpFormat::Text:
            dump_text_vkGetDisplayModePropertiesKHR(dump_inst, result, physicalDevice, display, pPropertyCount,
                                                    pProperties);
            break;
    }
    loader_platform_thread_unlock_mutex(dump_inst.outputMutex());
...
inline void dump_vkCreateSemaphore(ApiDumpInstance& dump_inst, VkResult result, VkDevice device,
                                   const VkSemaphoreCreateInfo* pCreateInfo, const VkAllocationCallbacks* pAllocator,
...
inline void dump_vkCreateDisplayModeKHR(ApiDumpInstance& dump_inst, VkResult result, VkPhysicalDevice physicalDevice,
                                        ...
                                        const VkAllocationCallbacks* pAllocator, VkDisplayModeKHR* pMode)
{
    ...
    {
        case ApiDumpFormat::Text:
            dump_text_vkCreateDisplayModeKHR(dump_inst, result, physicalDevice, display, pCreateInfo, pAllocator,
                                             pMode);
            break;
    }
    loader_platform_thread_unlock_mutex(dump_inst.outputMutex());
...
inline void dump_vkCreateShaderModule(ApiDumpInstance& dump_inst, VkResult result, VkDevice device,
...
inline void
dump_vkGetDisplayPlaneCapabilitiesKHR(ApiDumpInstance& dump_inst, VkResult result, VkPhysicalDevice physicalDevice,
                                      ...
                                      VkDisplayPlaneCapabilitiesKHR* pCapabilities)
{
    ...
    {
        case ApiDumpFormat::Text:
            dump_text_vkGetDisplayPlaneCapabilitiesKHR(dump_inst, result, physicalDevice, mode, planeIndex,
                                                       pCapabilities);
            break;
    }
    loader_platform_thread_unlock_mutex(dump_inst.outputMutex());
...
inline void
dump_vkDisplayPowerControlEXT(ApiDumpInstance& dump_inst, VkResult result, VkDevice device, VkDisplayKHR display,
...
inline void dump_vkCreateBufferView(ApiDumpInstance& dump_inst, VkResult result, VkDevice device,
                                    const VkBufferViewCreateInfo* pCreateInfo, const VkAllocationCallbacks* pAllocator,
                                    VkBufferView* pView)
{
    loader_platform_thread_lock_mutex(dump_inst.outputMutex());
    switch(dump_inst.settings().format())
...
inline void dump_vkCreateDisplayPlaneSurfaceKHR(ApiDumpInstance& dump_inst, VkResult result, VkInstance instance,
...
inline void dump_vkRegisterDeviceEventEXT(ApiDumpInstance& dump_inst, VkResult result, VkDevice device,
...
inline void
dump_vkQueuePresentKHR(ApiDumpInstance& dump_inst, VkResult result, VkQueue queue, const VkPresentInfoKHR* pPresentInfo)
{
    loader_platform_thread_lock_mutex(dump_inst.outputMutex());
    switch(dump_inst.settings().format())
    {
...
inline void
dump_vkRegisterDisplayEventEXT(ApiDumpInstance& dump_inst, VkResult result, VkDevice device, VkDisplayKHR display,
                               ...
                               VkFence* pFence)
{
    ...
    {
        case ApiDumpFormat::Text:
            dump_text_vkRegisterDisplayEventEXT(dump_inst, result, device, display, pDisplayEventInfo, pAllocator,
                                                pFence);
            break;
    }
    loader_platform_thread_unlock_mutex(dump_inst.outputMutex());
...
inline void
dump_vkCreateEvent(ApiDumpInstance& dump_inst, VkResult result, VkDevice device, const VkEventCreateInfo* pCreateInfo,
...
inline void
dump_vkGetSwapchainCounterEXT(ApiDumpInstance& dump_inst, VkResult result, VkDevice device, VkSwapchainKHR swapchain,
...
inline void dump_vkDebugMarkerSetObjectTagEXT(ApiDumpInstance& dump_inst, VkResult result, VkDevice device,
...
inline void dump_vkQueueBindSparse(ApiDumpInstance& dump_inst, VkResult result, VkQueue queue, uint32_t bindInfoCount,
...
inline void dump_vkCreatePipelineCache(ApiDumpInstance& dump_inst, VkResult result, VkDevice device,
...
inline void dump_vkResetDescriptorPool(ApiDumpInstance& dump_inst, VkResult result, VkDevice device,
...
inline void dump_vkAllocateDescriptorSets(ApiDumpInstance& dump_inst, VkResult result, VkDevice device,
...
inline void dump_vkResetCommandBuffer(ApiDumpInstance& dump_inst, VkResult result, VkCommandBuffer commandBuffer,
...
inline void dump_vkCreateDebugReportCallbackEXT(ApiDumpInstance& dump_inst, VkResult result, VkInstance instance,
...
inline void
dump_vkCreateImage(ApiDumpInstance& dump_inst, VkResult result, VkDevice device, const VkImageCreateInfo* pCreateInfo,
...
inline void dump_vkDebugMarkerSetObjectNameEXT(ApiDumpInstance& dump_inst, VkResult result, VkDevice device,
...
inline void dump_vkCreateIndirectCommandsLayoutNVX(ApiDumpInstance& dump_inst, VkResult result, VkDevice device,
                                                   ...
                                                   VkIndirectCommandsLayoutNVX* pIndirectCommandsLayout)
{
    ...
    {
        case ApiDumpFormat::Text:
            dump_text_vkCreateIndirectCommandsLayoutNVX(dump_inst, result, device, pCreateInfo, pAllocator,
...
inline void
dump_vkCreateSharedSwapchainsKHR(ApiDumpInstance& dump_inst, VkResult result, VkDevice device, uint32_t swapchainCount,
                                 ...
                                 VkSwapchainKHR* pSwapchains)
{
    ...
    {
        case ApiDumpFormat::Text:
            dump_text_vkCreateSharedSwapchainsKHR(dump_inst, result, device, swapchainCount, pCreateInfos, pAllocator,
                                                  pSwapchains);
            break;
    }
    loader_platform_thread_unlock_mutex(dump_inst.outputMutex());
...
inline void dump_vkCreateObjectTableNVX(ApiDumpInstance& dump_inst, VkResult result, VkDevice device,
...
inline void
dump_vkFreeDescriptorSets(ApiDumpInstance& dump_inst, VkResult result, VkDevice device, VkDescriptorPool descriptorPool,
                          uint32_t descriptorSetCount, const VkDescriptorSet* pDescriptorSets)
{
    ...
    {
        case ApiDumpFormat::Text:
            dump_text_vkFreeDescriptorSets(dump_inst, result, device, descriptorPool, descriptorSetCount,
                                           pDescriptorSets);
            break;
    }
    loader_platform_thread_unlock_mutex(dump_inst.outputMutex());
...
inline void dump_vkCreateQueryPool(ApiDumpInstance& dump_inst, VkResult result, VkDevice device,
                                   const VkQueryPoolCreateInfo* pCreateInfo, const VkAllocationCallbacks* pAllocator,
...
inline void
dump_vkGetPipelineCacheData(ApiDumpInstance& dump_inst, VkResult result, VkDevice device, VkPipelineCache pipelineCache,
...
inline void
dump_vkGetPhysicalDeviceSurfaceSupportKHR(ApiDumpInstance& dump_inst, VkResult result, VkPhysicalDevice physicalDevice,
                                          uint32_t queueFamilyIndex, VkSurfaceKHR surface, VkBool32* pSupported)
{
    ...
    {
        case ApiDumpFormat::Text:
            dump_text_vkGetPhysicalDeviceSurfaceSupportKHR(dump_inst, result, physicalDevice, queueFamilyIndex, surface,
                                                           pSupported);
            break;
    }
    loader_platform_thread_unlock_mutex(dump_inst.outputMutex());
...
inline void
dump_vkUnregisterObjectsNVX(ApiDumpInstance& dump_inst, VkResult result, VkDevice device, VkObjectTableNVX objectTable,
                            ...
                            const uint32_t* pObjectIndices)
{
    ...
    {
        case ApiDumpFormat::Text:
            dump_text_vkUnregisterObjectsNVX(dump_inst, result, device, objectTable, objectCount, pObjectEntryTypes,
                                             pObjectIndices);
            break;
    }
    loader_platform_thread_unlock_mutex(dump_inst.outputMutex());
...
inline void
dump_vkGetPhysicalDeviceSurfaceFormatsKHR(ApiDumpInstance& dump_inst, VkResult result, VkPhysicalDevice physicalDevice,
                                          ...
                                          VkSurfaceFormatKHR* pSurfaceFormats)
{
    ...
    {
        case ApiDumpFormat::Text:
            dump_text_vkGetPhysicalDeviceSurfaceFormatsKHR(dump_inst, result, physicalDevice, surface,
...
inline void
dump_vkMergePipelineCaches(ApiDumpInstance& dump_inst, VkResult result, VkDevice device, VkPipelineCache dstCache,
...
inline void
dump_vkRegisterObjectsNVX(ApiDumpInstance& dump_inst, VkResult result, VkDevice device, VkObjectTableNVX objectTable,
                          uint32_t objectCount, const VkObjectTableEntryNVX* const* ppObjectTableEntries,
                          const uint32_t* pObjectIndices)
{
    loader_platform_thread_lock_mutex(dump_inst.outputMutex());
    switch(dump_inst.settings().format())
    {
        case ApiDumpFormat::Text:
            dump_text_vkRegisterObjectsNVX(dump_inst, result, device, objectTable, objectCount, ppObjectTableEntries,
                                           pObjectIndices);
            break;
    }
    loader_platform_thread_unlock_mutex(dump_inst.outputMutex());
...
inline void dump_vkCreateGraphicsPipelines(ApiDumpInstance& dump_inst, VkResult result, VkDevice device,
                                           VkPipelineCache pipelineCache, uint32_t createInfoCount,
                                           ...
                                           const VkAllocationCallbacks* pAllocator, VkPipeline* pPipelines)
{
    ...
    {
        case ApiDumpFormat::Text:
            dump_text_vkCreateGraphicsPipelines(dump_inst, result, device, pipelineCache, createInfoCount, pCreateInfos,
                                                pAllocator, pPipelines);
            break;
    }
    loader_platform_thread_unlock_mutex(dump_inst.outputMutex());
...
inline void dump_vkCreateSwapchainKHR(ApiDumpInstance& dump_inst, VkResult result, VkDevice device,
...
inline void
dump_vkCreateFence(ApiDumpInstance& dump_inst, VkResult result, VkDevice device, const VkFenceCreateInfo* pCreateInfo,
                   const VkAllocationCallbacks* pAllocator, VkFence* pFence)
{
    loader_platform_thread_lock_mutex(dump_inst.outputMutex());
    switch(dump_inst.settings().format())
...
inline void dump_vkReleaseDisplayEXT(ApiDumpInstance& dump_inst, VkResult result, VkPhysicalDevice physicalDevice,
...
inline void dump_vkGetPhysicalDeviceSurfaceCapabilitiesKHR(ApiDumpInstance& dump_inst, VkResult result,
                                                           VkPhysicalDevice physicalDevice, VkSurfaceKHR surface,
                                                           VkSurfaceCapabilitiesKHR* pSurfaceCapabilities)
{
    ...
    {
        case ApiDumpFormat::Text:
            dump_text_vkGetPhysicalDeviceSurfaceCapabilitiesKHR(dump_inst, result, physicalDevice, surface,
                                                                pSurfaceCapabilities);
            break;
    }
    loader_platform_thread_unlock_mutex(dump_inst.outputMutex());
...
inline void dump_vkCreateImageView(ApiDumpInstance& dump_inst, VkResult result, VkDevice device,
...
inline void dump_vkCreateFramebuffer(ApiDumpInstance& dump_inst, VkResult result, VkDevice device,
...
inline void dump_vkCreateInstance(ApiDumpInstance& dump_inst, VkResult result, const VkInstanceCreateInfo* pCreateInfo,
...
inline void dump_vkGetPhysicalDeviceExternalImageFormatPropertiesNV(ApiDumpInstance& dump_inst, VkResult result,
                                                                    VkPhysicalDevice physicalDevice, VkFormat format,
                                                                    VkImageType type, VkImageTiling tiling,
                                                                    VkImageUsageFlags usage, VkImageCreateFlags flags,
                                                                    ...
                                                                    VkExternalImageFormatPropertiesNV* pExternalImageFormatProperties)
{
    ...
    {
        case ApiDumpFormat::Text:
            dump_text_vkGetPhysicalDeviceExternalImageFormatPropertiesNV(dump_inst, result, physicalDevice, format,
                                                                         type, tiling, usage, flags, externalHandleType,
...
inline void dump_vkEnumeratePhysicalDevices(ApiDumpInstance& dump_inst, VkResult result, VkInstance instance,
...
inline void
dump_vkGetQueryPoolResults(ApiDumpInstance& dump_inst, VkResult result, VkDevice device, VkQueryPool queryPool,
                           ...
                           VkQueryResultFlags flags)
{
    ...
    {
        case ApiDumpFormat::Text:
            dump_text_vkGetQueryPoolResults(dump_inst, result, device, queryPool, firstQuery, queryCount, dataSize,
                                            pData, stride, flags);
            break;
    }
    loader_platform_thread_unlock_mutex(dump_inst.outputMutex());
...
inline void dump_vkGetPhysicalDeviceSurfacePresentModesKHR(ApiDumpInstance& dump_inst, VkResult result,
                                                           VkPhysicalDevice physicalDevice, VkSurfaceKHR surface,
                                                           uint32_t* pPresentModeCount, VkPresentModeKHR* pPresentModes)
{
    ...
    {
        case ApiDumpFormat::Text:
            dump_text_vkGetPhysicalDeviceSurfacePresentModesKHR(dump_inst, result, physicalDevice, surface,
...
inline void
dump_vkGetPhysicalDeviceFormatProperties(ApiDumpInstance& dump_inst, VkPhysicalDevice physicalDevice, VkFormat format,
...
inline void
dump_vkCmdBindVertexBuffers(ApiDumpInstance& dump_inst, VkCommandBuffer commandBuffer, uint32_t firstBinding,
...
inline void
dump_vkCmdDraw(ApiDumpInstance& dump_inst, VkCommandBuffer commandBuffer, uint32_t vertexCount, uint32_t instanceCount,
...
inline void dump_vkDestroyFramebuffer(ApiDumpInstance& dump_inst, VkDevice device, VkFramebuffer framebuffer,
                                      const VkAllocationCallbacks* pAllocator)
{
    loader_platform_thread_lock_mutex(dump_inst.outputMutex());
    switch(dump_inst.settings().format())
...
inline void dump_vkCmdDrawIndexed(ApiDumpInstance& dump_inst, VkCommandBuffer commandBuffer, uint32_t indexCount,
                                  ...
                                  uint32_t firstInstance)
{
    ...
    {
        case ApiDumpFormat::Text:
            dump_text_vkCmdDrawIndexed(dump_inst, commandBuffer, indexCount, instanceCount, firstIndex, vertexOffset,
                                       firstInstance);
            break;
    }
    loader_platform_thread_unlock_mutex(dump_inst.outputMutex());
...
inline void
dump_vkCmdDrawIndirect(ApiDumpInstance& dump_inst, VkCommandBuffer commandBuffer, VkBuffer buffer, VkDeviceSize offset,
...
inline void dump_vkCmdDrawIndexedIndirect(ApiDumpInstance& dump_inst, VkCommandBuffer commandBuffer, VkBuffer buffer,
...
inline void
dump_vkGetDeviceQueue(ApiDumpInstance& dump_inst, VkDevice device, uint32_t queueFamilyIndex, uint32_t queueIndex,
                      VkQueue* pQueue)
{
    loader_platform_thread_lock_mutex(dump_inst.outputMutex());
    switch(dump_inst.settings().format())
...
inline void
dump_vkCmdDispatch(ApiDumpInstance& dump_inst, VkCommandBuffer commandBuffer, uint32_t x, uint32_t y, uint32_t z)
{
    loader_platform_thread_lock_mutex(dump_inst.outputMutex());
    switch(dump_inst.settings().format())
    {
...
inline void dump_vkCmdDispatchIndirect(ApiDumpInstance& dump_inst, VkCommandBuffer commandBuffer, VkBuffer buffer,
                                       VkDeviceSize offset)
{
    loader_platform_thread_lock_mutex(dump_inst.outputMutex());
    switch(dump_inst.settings().format())
...
inline void dump_vkGetPhysicalDeviceProperties(ApiDumpInstance& dump_inst, VkPhysicalDevice physicalDevice,
...
inline void dump_vkDestroyPipeline(ApiDumpInstance& dump_inst, VkDevice device, VkPipeline pipeline,
                                   const VkAllocationCallbacks* pAllocator)
{
    loader_platform_thread_lock_mutex(dump_inst.outputMutex());
    switch(dump_inst.settings().format())
...
inline void
dump_vkCmdCopyBuffer(ApiDumpInstance& dump_inst, VkCommandBuffer commandBuffer, VkBuffer srcBuffer, VkBuffer dstBuffer,
...
inline void dump_vkCmdCopyImage(ApiDumpInstance& dump_inst, VkCommandBuffer commandBuffer, VkImage srcImage,
                                ...
                                uint32_t regionCount, const VkImageCopy* pRegions)
{
    ...
    {
        case ApiDumpFormat::Text:
            dump_text_vkCmdCopyImage(dump_inst, commandBuffer, srcImage, srcImageLayout, dstImage, dstImageLayout,
...
inline void dump_vkCmdBlitImage(ApiDumpInstance& dump_inst, VkCommandBuffer commandBuffer, VkImage srcImage,
                                VkImageLayout srcImageLayout, VkImage dstImage, VkImageLayout dstImageLayout,
                                uint32_t regionCount, const VkImageBlit* pRegions, VkFilter filter)
{
    ...
    {
        case ApiDumpFormat::Text:
            dump_text_vkCmdBlitImage(dump_inst, commandBuffer, srcImage, srcImageLayout, dstImage, dstImageLayout,
...
inline void dump_vkDestroyPipelineLayout(ApiDumpInstance& dump_inst, VkDevice device, VkPipelineLayout pipelineLayout,
                                         const VkAllocationCallbacks* pAllocator)
{
    loader_platform_thread_lock_mutex(dump_inst.outputMutex());
    switch(dump_inst.settings().format())
...
inline void dump_vkDestroyRenderPass(ApiDumpInstance& dump_inst, VkDevice device, VkRenderPass renderPass,
                                     const VkAllocationCallbacks* pAllocator)
{
    loader_platform_thread_lock_mutex(dump_inst.outputMutex());
    switch(dump_inst.settings().format())
...
inline void dump_vkGetPhysicalDeviceQueueFamilyProperties(ApiDumpInstance& dump_inst, VkPhysicalDevice physicalDevice,
                                                          ...
                                                          VkQueueFamilyProperties* pQueueFamilyProperties)
{
    ...
    {
        case ApiDumpFormat::Text:
            dump_text_vkGetPhysicalDeviceQueueFamilyProperties(dump_inst, physicalDevice, pQueueFamilyPropertyCount,
...
inline void dump_vkCmdCopyBufferToImage(ApiDumpInstance& dump_inst, VkCommandBuffer commandBuffer, VkBuffer srcBuffer,
                                        ...
                                        const VkBufferImageCopy* pRegions)
{
    ...
    {
        case ApiDumpFormat::Text:
            dump_text_vkCmdCopyBufferToImage(dump_inst, commandBuffer, srcBuffer, dstImage, dstImageLayout, regionCount,
                                             pRegions);
            break;
    }
    loader_platform_thread_unlock_mutex(dump_inst.outputMutex());
...
inline void dump_vkFreeMemory(ApiDumpInstance& dump_inst, VkDevice device, VkDeviceMemory memory,
                              const VkAllocationCallbacks* pAllocator)
{
    loader_platform_thread_lock_mutex(dump_inst.outputMutex());
    switch(dump_inst.settings().format())
...
inline void dump_vkCmdCopyImageToBuffer(ApiDumpInstance& dump_inst, VkCommandBuffer commandBuffer, VkImage srcImage,
                                        ...
                                        const VkBufferImageCopy* pRegions)
{
    ...
    {
        case ApiDumpFormat::Text:
            dump_text_vkCmdCopyImageToBuffer(dump_inst, commandBuffer, srcImage, srcImageLayout, dstBuffer, regionCount,
                                             pRegions);
            break;
    }
    loader_platform_thread_unlock_mutex(dump_inst.outputMutex());
...
inline void dump_vkGetRenderAreaGranularity(ApiDumpInstance& dump_inst, VkDevice device, VkRenderPass renderPass,
...
inline void dump_vkCmdUpdateBuffer(ApiDumpInstance& dump_inst, VkCommandBuffer commandBuffer, VkBuffer dstBuffer,
...
inline void dump_vkCmdFillBuffer(ApiDumpInstance& dump_inst, VkCommandBuffer commandBuffer, VkBuffer dstBuffer,
...
inline void dump_vkGetDeviceMemoryCommitment(ApiDumpInstance& dump_inst, VkDevice device, VkDeviceMemory memory,
...
inline void dump_vkDestroyCommandPool(ApiDumpInstance& dump_inst, VkDevice device, VkCommandPool commandPool,
                                      const VkAllocationCallbacks* pAllocator)
{
    loader_platform_thread_lock_mutex(dump_inst.outputMutex());
    switch(dump_inst.settings().format())
...
inline void dump_vkCmdClearColorImage(ApiDumpInstance& dump_inst, VkCommandBuffer commandBuffer, VkImage image,
...
inline void
dump_vkGetPhysicalDeviceQueueFamilyProperties2KHR(ApiDumpInstance& dump_inst, VkPhysicalDevice physicalDevice,
                                                  uint32_t* pQueueFamilyPropertyCount,
                                                  VkQueueFamilyProperties2KHR* pQueueFamilyProperties)
{
    ...
    {
        case ApiDumpFormat::Text:
            dump_text_vkGetPhysicalDeviceQueueFamilyProperties2KHR(dump_inst, physicalDevice, pQueueFamilyPropertyCount,
                                                                   pQueueFamilyProperties);
            break;
    }
    loader_platform_thread_unlock_mutex(dump_inst.outputMutex());
...
inline void
dump_vkCmdEndQuery(ApiDumpInstance& dump_inst, VkCommandBuffer commandBuffer, VkQueryPool queryPool, uint32_t query)
{
    loader_platform_thread_lock_mutex(dump_inst.outputMutex());
    switch(dump_inst.settings().format())
    {
...
inline void dump_vkCmdResetQueryPool(ApiDumpInstance& dump_inst, VkCommandBuffer commandBuffer, VkQueryPool queryPool,
...
inline void
dump_vkGetPhysicalDeviceSparseImageFormatProperties2KHR(ApiDumpInstance& dump_inst, VkPhysicalDevice physicalDevice,
                                                        ...
                                                        VkSparseImageFormatProperties2KHR* pProperties)
{
    ...
    {
        case ApiDumpFormat::Text:
            dump_text_vkGetPhysicalDeviceSparseImageFormatProperties2KHR(dump_inst, physicalDevice, pFormatInfo,
                                                                         pPropertyCount, pProperties);
            break;
    }
    loader_platform_thread_unlock_mutex(dump_inst.outputMutex());
...
inline void dump_vkGetPhysicalDeviceMemoryProperties2KHR(ApiDumpInstance& dump_inst, VkPhysicalDevice physicalDevice,
...
inline void dump_vkDestroySampler(ApiDumpInstance& dump_inst, VkDevice device, VkSampler sampler,
                                  const VkAllocationCallbacks* pAllocator)
{
    loader_platform_thread_lock_mutex(dump_inst.outputMutex());
    switch(dump_inst.settings().format())
...
inline void
dump_vkDestroyFence(ApiDumpInstance& dump_inst, VkDevice device, VkFence fence, const VkAllocationCallbacks* pAllocator)
{
    loader_platform_thread_lock_mutex(dump_inst.outputMutex());
    switch(dump_inst.settings().format())
    {
...
inline void dump_vkGetImageMemoryRequirements(ApiDumpInstance& dump_inst, VkDevice device, VkImage image,
...
inline void dump_vkCmdClearDepthStencilImage(ApiDumpInstance& dump_inst, VkCommandBuffer commandBuffer, VkImage image,
                                             ...
                                             uint32_t rangeCount, const VkImageSubresourceRange* pRanges)
{
    ...
    {
        case ApiDumpFormat::Text:
            dump_text_vkCmdClearDepthStencilImage(dump_inst, commandBuffer, image, imageLayout, pDepthStencil,
                                                  rangeCount, pRanges);
            break;
    }
    loader_platform_thread_unlock_mutex(dump_inst.outputMutex());
...
inline void dump_vkDestroyDescriptorSetLayout(ApiDumpInstance& dump_inst, VkDevice device,
...
inline void dump_vkCmdWriteTimestamp(ApiDumpInstance& dump_inst, VkCommandBuffer commandBuffer,
...
inline void dump_vkFreeCommandBuffers(ApiDumpInstance& dump_inst, VkDevice device, VkCommandPool commandPool,
...
inline void dump_vkGetBufferMemoryRequirements(ApiDumpInstance& dump_inst, VkDevice device, VkBuffer buffer,
                                               VkMemoryRequirements* pMemoryRequirements)
{
    loader_platform_thread_lock_mutex(dump_inst.outputMutex());
    switch(dump_inst.settings().format())
...
inline void dump_vkCmdPushConstants(ApiDumpInstance& dump_inst, VkCommandBuffer commandBuffer, VkPipelineLayout layout,
...
inline void
dump_vkCmdCopyQueryPoolResults(ApiDumpInstance& dump_inst, VkCommandBuffer commandBuffer, VkQueryPool queryPool,
                               ...
                               VkDeviceSize stride, VkQueryResultFlags flags)
{
    ...
    {
        case ApiDumpFormat::Text:
            dump_text_vkCmdCopyQueryPoolResults(dump_inst, commandBuffer, queryPool, firstQuery, queryCount, dstBuffer,
...
inline void
dump_vkCmdClearAttachments(ApiDumpInstance& dump_inst, VkCommandBuffer commandBuffer, uint32_t attachmentCount,
...
inline void dump_vkDestroyBuffer(ApiDumpInstance& dump_inst, VkDevice device, VkBuffer buffer,
                                 const VkAllocationCallbacks* pAllocator)
{
    loader_platform_thread_lock_mutex(dump_inst.outputMutex());
    switch(dump_inst.settings().format())
...
inline void dump_vkGetImageSparseMemoryRequirements(ApiDumpInstance& dump_inst, VkDevice device, VkImage image,
                                                    ...
                                                    VkSparseImageMemoryRequirements* pSparseMemoryRequirements)
{
    ...
    {
        case ApiDumpFormat::Text:
            dump_text_vkGetImageSparseMemoryRequirements(dump_inst, device, image, pSparseMemoryRequirementCount,
...
inline void dump_vkCmdBeginRenderPass(ApiDumpInstance& dump_inst, VkCommandBuffer commandBuffer,
...
inline void dump_vkDestroySemaphore(ApiDumpInstance& dump_inst, VkDevice device, VkSemaphore semaphore,
                                    const VkAllocationCallbacks* pAllocator)
{
    loader_platform_thread_lock_mutex(dump_inst.outputMutex());
    switch(dump_inst.settings().format())
...
inline void dump_vkDestroyImageView(ApiDumpInstance& dump_inst, VkDevice device, VkImageView imageView,
                                    const VkAllocationCallbacks* pAllocator)
{
    loader_platform_thread_lock_mutex(dump_inst.outputMutex());
    switch(dump_inst.settings().format())
...
inline void dump_vkCmdResolveImage(ApiDumpInstance& dump_inst, VkCommandBuffer commandBuffer, VkImage srcImage,
                                   VkImageLayout srcImageLayout, VkImage dstImage, VkImageLayout dstImageLayout,
                                   uint32_t regionCount, const VkImageResolve* pRegions)
{
    ...
    {
        case ApiDumpFormat::Text:
            dump_text_vkCmdResolveImage(dump_inst, commandBuffer, srcImage, srcImageLayout, dstImage, dstImageLayout,
                                        regionCount, pRegions);
            break;
    }
    loader_platform_thread_unlock_mutex(dump_inst.outputMutex());
...
inline void
dump_vkGetPhysicalDeviceSparseImageFormatProperties(ApiDumpInstance& dump_inst, VkPhysicalDevice physicalDevice,
                                                    ...
                                                    VkSparseImageFormatProperties* pProperties)
{
    ...
    {
        case ApiDumpFormat::Text:
            dump_text_vkGetPhysicalDeviceSparseImageFormatProperties(dump_inst, physicalDevice, format, type, samples,
...
inline void dump_vkCmdDrawIndirectCountAMD(ApiDumpInstance& dump_inst, VkCommandBuffer commandBuffer, VkBuffer buffer,
                                           ...
                                           uint32_t maxDrawCount, uint32_t stride)
{
    ...
    {
        case ApiDumpFormat::Text:
            dump_text_vkCmdDrawIndirectCountAMD(dump_inst, commandBuffer, buffer, offset, countBuffer,
...
inline void dump_vkTrimCommandPoolKHR(ApiDumpInstance& dump_inst, VkDevice device, VkCommandPool commandPool,
...
inline void dump_vkCmdSetEvent(ApiDumpInstance& dump_inst, VkCommandBuffer commandBuffer, VkEvent event,
...
inline void
dump_vkCmdDrawIndexedIndirectCountAMD(ApiDumpInstance& dump_inst, VkCommandBuffer commandBuffer, VkBuffer buffer,
                                      VkDeviceSize offset, VkBuffer countBuffer, VkDeviceSize countBufferOffset,
                                      uint32_t maxDrawCount, uint32_t stride)
{
    loader_platform_thread_lock_mutex(dump_inst.outputMutex());
    ...
    {
        case ApiDumpFormat::Text:
            dump_text_vkCmdDrawIndexedIndirectCountAMD(dump_inst, commandBuffer, buffer, offset, countBuffer,
                                                       countBufferOffset, maxDrawCount, stride);
            break;
    }
    loader_platform_thread_unlock_mutex(dump_inst.outputMutex());
...
inline void dump_vkDestroyDescriptorPool(ApiDumpInstance& dump_inst, VkDevice device, VkDescriptorPool descriptorPool,
                                         const VkAllocationCallbacks* pAllocator)
{
    loader_platform_thread_lock_mutex(dump_inst.outputMutex());
    switch(dump_inst.settings().format())
...
inline void dump_vkCmdProcessCommandsNVX(ApiDumpInstance& dump_inst, VkCommandBuffer commandBuffer,
...
inline void dump_vkDestroyShaderModule(ApiDumpInstance& dump_inst, VkDevice device, VkShaderModule shaderModule,
                                       const VkAllocationCallbacks* pAllocator)
{
    loader_platform_thread_lock_mutex(dump_inst.outputMutex());
    switch(dump_inst.settings().format())
...
inline void
dump_vkCmdExecuteCommands(ApiDumpInstance& dump_inst, VkCommandBuffer commandBuffer, uint32_t commandBufferCount,
...
inline void
dump_vkDestroyEvent(ApiDumpInstance& dump_inst, VkDevice device, VkEvent event, const VkAllocationCallbacks* pAllocator)
{
    loader_platform_thread_lock_mutex(dump_inst.outputMutex());
    switch(dump_inst.settings().format())
    {
...
inline void dump_vkDestroyBufferView(ApiDumpInstance& dump_inst, VkDevice device, VkBufferView bufferView,
                                     const VkAllocationCallbacks* pAllocator)
{
    loader_platform_thread_lock_mutex(dump_inst.outputMutex());
    switch(dump_inst.settings().format())
...
inline void
dump_vkCmdBindPipeline(ApiDumpInstance& dump_inst, VkCommandBuffer commandBuffer, VkPipelineBindPoint pipelineBindPoint,
                       VkPipeline pipeline)
{
    loader_platform_thread_lock_mutex(dump_inst.outputMutex());
    switch(dump_inst.settings().format())
...
inline void dump_vkCmdReserveSpaceForCommandsNVX(ApiDumpInstance& dump_inst, VkCommandBuffer commandBuffer,
...
inline void dump_vkCmdSetViewport(ApiDumpInstance& dump_inst, VkCommandBuffer commandBuffer, uint32_t firstViewport,
...
inline void dump_vkCmdResetEvent(ApiDumpInstance& dump_inst, VkCommandBuffer commandBuffer, VkEvent event,
                                 VkPipelineStageFlags stageMask)
{
    loader_platform_thread_lock_mutex(dump_inst.outputMutex());
    switch(dump_inst.settings().format())
...
inline void dump_vkCmdWaitEvents(ApiDumpInstance& dump_inst, VkCommandBuffer commandBuffer, uint32_t eventCount,
                                 ...
                                 const VkImageMemoryBarrier* pImageMemoryBarriers)
{
    ...
    {
        case ApiDumpFormat::Text:
            dump_text_vkCmdWaitEvents(dump_inst, commandBuffer, eventCount, pEvents, srcStageMask, dstStageMask,
...
inline void
dump_vkDestroyImage(ApiDumpInstance& dump_inst, VkDevice device, VkImage image, const VkAllocationCallbacks* pAllocator)
{
    loader_platform_thread_lock_mutex(dump_inst.outputMutex());
    switch(dump_inst.settings().format())
    {
...
inline void dump_vkCmdDebugMarkerBeginEXT(ApiDumpInstance& dump_inst, VkCommandBuffer commandBuffer,
...
inline void dump_vkCmdSetScissor(ApiDumpInstance& dump_inst, VkCommandBuffer commandBuffer, uint32_t firstScissor,
...
inline void dump_vkDestroyIndirectCommandsLayoutNVX(ApiDumpInstance& dump_inst, VkDevice device,
...
inline void
dump_vkCmdSetDepthBias(ApiDumpInstance& dump_inst, VkCommandBuffer commandBuffer, float depthBiasConstantFactor,
                       float depthBiasClamp, float depthBiasSlopeFactor)
{
    ...
    {
        case ApiDumpFormat::Text:
            dump_text_vkCmdSetDepthBias(dump_inst, commandBuffer, depthBiasConstantFactor, depthBiasClamp,
...
inline void dump_vkDestroyObjectTableNVX(ApiDumpInstance& dump_inst, VkDevice device, VkObjectTableNVX objectTable,
                                         const VkAllocationCallbacks* pAllocator)
{
    loader_platform_thread_lock_mutex(dump_inst.outputMutex());
    switch(dump_inst.settings().format())
...
inline void dump_vkDestroyPipelineCache(ApiDumpInstance& dump_inst, VkDevice device, VkPipelineCache pipelineCache,
                                        const VkAllocationCallbacks* pAllocator)
{
    loader_platform_thread_lock_mutex(dump_inst.outputMutex());
    switch(dump_inst.settings().format())
...
inline void dump_vkDestroySurfaceKHR(ApiDumpInstance& dump_inst, VkInstance instance, VkSurfaceKHR surface,
                                     const VkAllocationCallbacks* pAllocator)
{
    loader_platform_thread_lock_mutex(dump_inst.outputMutex());
    switch(dump_inst.settings().format())
...
inline void dump_vkCmdDebugMarkerInsertEXT(ApiDumpInstance& dump_inst, VkCommandBuffer commandBuffer,
                                           VkDebugMarkerMarkerInfoEXT* pMarkerInfo)
{
    loader_platform_thread_lock_mutex(dump_inst.outputMutex());
    switch(dump_inst.settings().format())
...
inline void dump_vkUpdateDescriptorSets(ApiDumpInstance& dump_inst, VkDevice device, uint32_t descriptorWriteCount,
                                        ...
                                        const VkCopyDescriptorSet* pDescriptorCopies)
{
    ...
    {
        case ApiDumpFormat::Text:
            dump_text_vkUpdateDescriptorSets(dump_inst, device, descriptorWriteCount, pDescriptorWrites,
...
inline void
dump_vkDestroyDebugReportCallbackEXT(ApiDumpInstance& dump_inst, VkInstance instance, VkDebugReportCallbackEXT callback,
                                     const VkAllocationCallbacks* pAllocator)
{
    loader_platform_thread_lock_mutex(dump_inst.outputMutex());
    switch(dump_inst.settings().format())
...
inline void
dump_vkCmdSetBlendConstants(ApiDumpInstance& dump_inst, VkCommandBuffer commandBuffer, const float blendConstants[4])
{
    loader_platform_thread_lock_mutex(dump_inst.outputMutex());
    switch(dump_inst.settings().format())
    {
...
inline void dump_vkCmdSetDepthBounds(ApiDumpInstance& dump_inst, VkCommandBuffer commandBuffer, float minDepthBounds,
...
inline void dump_vkDebugReportMessageEXT(ApiDumpInstance& dump_inst, VkInstance instance, VkDebugReportFlagsEXT flags,
                                         ...
                                         int32_t messageCode, const char* pLayerPrefix, const char* pMessage)
{
    ...
    {
        case ApiDumpFormat::Text:
            dump_text_vkDebugReportMessageEXT(dump_inst, instance, flags, objectType, object, location, messageCode,
...
inline void
dump_vkGetPhysicalDeviceGeneratedCommandsPropertiesNVX(ApiDumpInstance& dump_inst, VkPhysicalDevice physicalDevice,
...
inline void
dump_vkCmdPipelineBarrier(ApiDumpInstance& dump_inst, VkCommandBuffer commandBuffer, VkPipelineStageFlags srcStageMask,
                          ...
                          uint32_t imageMemoryBarrierCount, const VkImageMemoryBarrier* pImageMemoryBarriers)
{
    ...
    {
        case ApiDumpFormat::Text:
            dump_text_vkCmdPipelineBarrier(dump_inst, commandBuffer, srcStageMask, dstStageMask, dependencyFlags,
                                           memoryBarrierCount, pMemoryBarriers, bufferMemoryBarrierCount,
                                           pBufferMemoryBarriers, imageMemoryBarrierCount, pImageMemoryBarriers);
            break;
    }
...
inline void
dump_vkCmdSetStencilCompareMask(ApiDumpInstance& dump_inst, VkCommandBuffer commandBuffer, VkStencilFaceFlags faceMask,
...
inline void dump_vkDestroyQueryPool(ApiDumpInstance& dump_inst, VkDevice device, VkQueryPool queryPool,
                                    const VkAllocationCallbacks* pAllocator)
{
    loader_platform_thread_lock_mutex(dump_inst.outputMutex());
    switch(dump_inst.settings().format())
...
inline void dump_vkGetImageSubresourceLayout(ApiDumpInstance& dump_inst, VkDevice device, VkImage image,
...
inline void
dump_vkCmdSetStencilWriteMask(ApiDumpInstance& dump_inst, VkCommandBuffer commandBuffer, VkStencilFaceFlags faceMask,
                              uint32_t writeMask)
{
    loader_platform_thread_lock_mutex(dump_inst.outputMutex());
    switch(dump_inst.settings().format())
...
inline void dump_vkGetPhysicalDeviceFeatures2KHR(ApiDumpInstance& dump_inst, VkPhysicalDevice physicalDevice,
...
inline void
dump_vkDestroyInstance(ApiDumpInstance& dump_inst, VkInstance instance, const VkAllocationCallbacks* pAllocator)
{
    loader_platform_thread_lock_mutex(dump_inst.outputMutex());
    switch(dump_inst.settings().format())
    {
...
inline void dump_vkDestroySwapchainKHR(ApiDumpInstance& dump_inst, VkDevice device, VkSwapchainKHR swapchain,
                                       const VkAllocationCallbacks* pAllocator)
{
    loader_platform_thread_lock_mutex(dump_inst.outputMutex());
    switch(dump_inst.settings().format())
...
inline void
dump_vkCmdSetStencilReference(ApiDumpInstance& dump_inst, VkCommandBuffer commandBuffer, VkStencilFaceFlags faceMask,
                              uint32_t reference)
{
    loader_platform_thread_lock_mutex(dump_inst.outputMutex());
    switch(dump_inst.settings().format())
...
inline void dump_vkGetPhysicalDeviceFeatures(ApiDumpInstance& dump_inst, VkPhysicalDevice physicalDevice,
...
inline void dump_vkCmdBindDescriptorSets(ApiDumpInstance& dump_inst, VkCommandBuffer commandBuffer,
                                         ...
                                         const uint32_t* pDynamicOffsets)
{
    ...
    {
        case ApiDumpFormat::Text:
            dump_text_vkCmdBindDescriptorSets(dump_inst, commandBuffer, pipelineBindPoint, layout, firstSet,
...
inline void dump_vkGetPhysicalDeviceMemoryProperties(ApiDumpInstance& dump_inst, VkPhysicalDevice physicalDevice,
...
inline void dump_vkGetPhysicalDeviceProperties2KHR(ApiDumpInstance& dump_inst, VkPhysicalDevice physicalDevice,
...
inline void dump_vkCmdBindIndexBuffer(ApiDumpInstance& dump_inst, VkCommandBuffer commandBuffer, VkBuffer buffer,
...
inline void
dump_vkCmdBeginQuery(ApiDumpInstance& dump_inst, VkCommandBuffer commandBuffer, VkQueryPool queryPool, uint32_t query,
...
inline void dump_vkGetPhysicalDeviceFormatProperties2KHR(ApiDumpInstance& dump_inst, VkPhysicalDevice physicalDevice,
...
instance_dispatch_table(instance)
->
...
return
util_GetLayerProperties(ARRAY_SIZE(layerProperties), layerProperties, pPropertyCount, pProperties
);
}
...
usage,
VkImageCreateFlags flags, VkImageFormatProperties
* pImageFormatProperties)
{
...
physicalDevice,
const VkPhysicalDeviceImageFormatInfo2KHR* pImageFormatInfo, VkImageFormatProperties2KHR
* pImageFormatProperties)
{
VkResult result = instance_dispatch_table(physicalDevice)
...
physicalDevice,
uint32_t* pPropertyCount, VkDisplayPropertiesKHR
* pProperties)
{
VkResult result = instance_dispatch_table(physicalDevice)
...
VK_LAYER_EXPORT VKAPI_ATTR
VkResult VKAPI_CALL
vkGetPhysicalDeviceSurfaceCapabilities2EXT(VkPhysicalDevice
physicalDevice,
...
physicalDevice,
uint32_t* pPropertyCount, VkDisplayPlanePropertiesKHR
* pProperties)
{
VkResult result = instance_dispatch_table(physicalDevice)
...
physicalDevice,
VkDisplayModeKHR mode, uint32_t
planeIndex,
VkDisplayPlaneCapabilitiesKHR* pCapabilities
)
{
...
* pSurface)
{
VkResult result = instance_dispatch_table(instance)
...
{
VkResult result = instance_dispatch_table(instance)
        ->CreateDebugReportCallbackEXT(instance, pCreateInfo, pAllocator, pCallback);
...
physicalDevice,
uint32_t queueFamilyIndex, VkSurfaceKHR
surface,
VkBool32* pSupported
)
{
...
VK_LAYER_EXPORT VKAPI_ATTR
VkResult VKAPI_CALL
vkReleaseDisplayEXT(VkPhysicalDevice
physicalDevice,
VkDisplayKHR display
)
{
...
physicalDevice,
VkSurfaceKHR surface, VkSurfaceCapabilitiesKHR
* pSurfaceCapabilities)
{
VkResult result = instance_dispatch_table(physicalDevice)
...
instance,
uint32_t* pPhysicalDeviceCount, VkPhysicalDevice
* pPhysicalDevices)
{
VkResult result = instance_dispatch_table(instance)
...
physicalDevice,
VkFormat format, VkFormatProperties
* pFormatProperties)
{
...
physicalDevice,
uint32_t* pQueueFamilyPropertyCount, VkQueueFamilyProperties
* pQueueFamilyProperties)
{
instance_dispatch_table(physicalDevice)
->
...
VK_LAYER_EXPORT VKAPI_ATTR
void VKAPI_CALL
vkGetPhysicalDeviceQueueFamilyProperties2KHR(VkPhysicalDevice
physicalDevice,
uint32_t* pQueueFamilyPropertyCount, VkQueueFamilyProperties2KHR
* pQueueFamilyProperties)
{
instance_dispatch_table(physicalDevice)
->
...
VK_LAYER_EXPORT VKAPI_ATTR
void VKAPI_CALL
vkGetPhysicalDeviceMemoryProperties2KHR(VkPhysicalDevice
physicalDevice,
VkPhysicalDeviceMemoryProperties2KHR* pMemoryProperties
)
{
...
VK_LAYER_EXPORT VKAPI_ATTR
void VKAPI_CALL
vkGetPhysicalDeviceSparseImageFormatProperties(VkPhysicalDevice
physicalDevice,
VkFormat format, VkImageType
type,
...
instance_dispatch_table(instance)
->
DebugReportMessageEXT(instance, flags, objectType, object, location, messageCode, pLayerPrefix, pMessage
);
...
VK_LAYER_EXPORT VKAPI_ATTR
void VKAPI_CALL
vkGetPhysicalDeviceGeneratedCommandsPropertiesNVX(VkPhysicalDevice
physicalDevice,
VkDeviceGeneratedCommandsFeaturesNVX* pFeatures, VkDeviceGeneratedCommandsLimitsNVX
* pLimits)
{
instance_dispatch_table(physicalDevice)
->
...
VK_LAYER_EXPORT VKAPI_ATTR
void VKAPI_CALL
vkGetPhysicalDeviceProperties2KHR(VkPhysicalDevice
physicalDevice,
VkPhysicalDeviceProperties2KHR* pProperties
)
{
...
VK_LAYER_EXPORT VKAPI_ATTR
void VKAPI_CALL
vkGetPhysicalDeviceFormatProperties2KHR(VkPhysicalDevice
physicalDevice,
VkFormat format, VkFormatProperties2KHR
* pFormatProperties)
{
instance_dispatch_table(physicalDevice)
->
...
VK_LAYER_EXPORT VKAPI_ATTR
VkResult VKAPI_CALL
vkCreateDescriptorSetLayout(VkDevice
device,
const VkDescriptorSetLayoutCreateInfo* pCreateInfo,
const VkAllocationCallbacks* pAllocator, VkDescriptorSetLayout
* pSetLayout)
{
...
* pPipelines)
{
VkResult result = device_dispatch_table(device)
...
const VkSubmitInfo* pSubmits, VkFence
fence)
{
...
VK_LAYER_EXPORT VKAPI_ATTR
VkResult VKAPI_CALL
vkFlushMappedMemoryRanges(VkDevice
device,
...
VK_LAYER_EXPORT VKAPI_ATTR
VkResult VKAPI_CALL
vkInvalidateMappedMemoryRanges(VkDevice
device,
uint32_t memoryRangeCount,
const VkMappedMemoryRange* pMemoryRanges
)
...
VK_LAYER_EXPORT VKAPI_ATTR
VkResult VKAPI_CALL
vkCreateDescriptorPool(VkDevice
device,
const VkDescriptorPoolCreateInfo* pCreateInfo,
...
{
VkResult result = device_dispatch_table(device)
        ->RegisterDisplayEventEXT(device, display, pDisplayEventInfo, pAllocator, pFence);
...
device,
VkSwapchainKHR swapchain, VkSurfaceCounterFlagBitsEXT
counter,
...
VK_LAYER_EXPORT VKAPI_ATTR
VkResult VKAPI_CALL
vkDebugMarkerSetObjectTagEXT(VkDevice
device,
VkDebugMarkerObjectTagInfoEXT* pTagInfo
)
{
...
VK_LAYER_EXPORT VKAPI_ATTR
VkResult VKAPI_CALL
vkQueueBindSparse(VkQueue
queue,
uint32_t bindInfoCount,
const VkBindSparseInfo* pBindInfo, VkFence
fence)
{
...
VK_LAYER_EXPORT VKAPI_ATTR
VkResult VKAPI_CALL
vkResetDescriptorPool(VkDevice
device,
VkDescriptorPool descriptorPool, VkDescriptorPoolResetFlags
flags)
{
...
VK_LAYER_EXPORT VKAPI_ATTR
VkResult VKAPI_CALL
vkDebugMarkerSetObjectNameEXT(VkDevice
device,
VkDebugMarkerObjectNameInfoEXT* pNameInfo
)
{
...
VK_LAYER_EXPORT VKAPI_ATTR
VkResult VKAPI_CALL
vkMergePipelineCaches(VkDevice
device,
...
VK_LAYER_EXPORT VKAPI_ATTR
VkResult VKAPI_CALL
vkCreateGraphicsPipelines(VkDevice
device,
VkPipelineCache pipelineCache, uint32_t
createInfoCount,
const VkGraphicsPipelineCreateInfo* pCreateInfos,
...
VK_LAYER_EXPORT VKAPI_ATTR
void VKAPI_CALL
vkCmdDrawIndirect(VkCommandBuffer
commandBuffer,
VkBuffer buffer, VkDeviceSize
offset,
uint32_t drawCount, uint32_t
stride)
{
device_dispatch_table(commandBuffer)
->
...
VK_LAYER_EXPORT VKAPI_ATTR
void VKAPI_CALL
vkCmdDrawIndexedIndirect(VkCommandBuffer
commandBuffer,
VkBuffer buffer, VkDeviceSize
offset,
uint32_t drawCount, uint32_t
...
VK_LAYER_EXPORT VKAPI_ATTR
void VKAPI_CALL
vkDestroyPipelineLayout(VkDevice
device,
...
VK_LAYER_EXPORT VKAPI_ATTR
void VKAPI_CALL
vkGetRenderAreaGranularity(VkDevice
device,
...
VK_LAYER_EXPORT VKAPI_ATTR
void VKAPI_CALL
vkGetDeviceMemoryCommitment(VkDevice
device,
VkDeviceMemory memory, VkDeviceSize
...
VK_LAYER_EXPORT VKAPI_ATTR
void VKAPI_CALL
vkCmdResetQueryPool(VkCommandBuffer
commandBuffer,
VkQueryPool queryPool, uint32_t
firstQuery,
uint32_t queryCount
...
VK_LAYER_EXPORT VKAPI_ATTR
void VKAPI_CALL
vkCmdClearDepthStencilImage(VkCommandBuffer
commandBuffer,
VkImage image, VkImageLayout
imageLayout,
...
VK_LAYER_EXPORT VKAPI_ATTR
void VKAPI_CALL
vkDestroyDescriptorSetLayout(VkDevice
device,
VkDescriptorSetLayout descriptorSetLayout,
const VkAllocationCallbacks* pAllocator
)
...
device,
VkBuffer buffer, VkMemoryRequirements
* pMemoryRequirements)
{
device_dispatch_table(device)
->
...
VK_LAYER_EXPORT VKAPI_ATTR
void VKAPI_CALL
vkCmdCopyQueryPoolResults(VkCommandBuffer
commandBuffer,
VkQueryPool queryPool, uint32_t
firstQuery,
uint32_t queryCount, VkBuffer
dstBuffer,
VkDeviceSize dstOffset, VkDeviceSize
stride,
VkQueryResultFlags flags
)
{
...
VK_LAYER_EXPORT VKAPI_ATTR
void VKAPI_CALL
vkCmdClearAttachments(VkCommandBuffer
commandBuffer,
...
VK_LAYER_EXPORT VKAPI_ATTR
void VKAPI_CALL
vkCmdNextSubpass(VkCommandBuffer
commandBuffer,
...
VK_LAYER_EXPORT VKAPI_ATTR
void VKAPI_CALL
vkCmdDrawIndirectCountAMD(VkCommandBuffer
commandBuffer,
VkBuffer buffer, VkDeviceSize
offset,
VkBuffer countBuffer, VkDeviceSize
countBufferOffset,
uint32_t maxDrawCount, uint32_t
stride)
{
device_dispatch_table(commandBuffer)
->
...
VK_LAYER_EXPORT VKAPI_ATTR
void VKAPI_CALL
vkCmdDrawIndexedIndirectCountAMD(VkCommandBuffer
commandBuffer,
VkBuffer buffer, VkDeviceSize
offset,
VkBuffer countBuffer, VkDeviceSize
...
VK_LAYER_EXPORT VKAPI_ATTR
void VKAPI_CALL
vkCmdProcessCommandsNVX(VkCommandBuffer
commandBuffer,
const VkCmdProcessCommandsInfoNVX* pProcessCommandsInfo
)
{
...
VK_LAYER_EXPORT VKAPI_ATTR
void VKAPI_CALL
vkCmdExecuteCommands(VkCommandBuffer
commandBuffer,
...
commandBuffer,
VkPipelineBindPoint pipelineBindPoint, VkPipeline
pipeline)
{
device_dispatch_table(commandBuffer)
->
...
VK_LAYER_EXPORT VKAPI_ATTR
void VKAPI_CALL
vkCmdReserveSpaceForCommandsNVX(VkCommandBuffer
commandBuffer,
const VkCmdReserveSpaceForCommandsInfoNVX* pReserveSpaceInfo
)
{
...
VK_LAYER_EXPORT VKAPI_ATTR
void VKAPI_CALL
vkCmdResetEvent(VkCommandBuffer
commandBuffer,
VkEvent event, VkPipelineStageFlags
stageMask)
{
...
VK_LAYER_EXPORT VKAPI_ATTR
void VKAPI_CALL
vkCmdSetLineWidth(VkCommandBuffer
commandBuffer,
float lineWidth
)
{
...
commandBuffer,
uint32_t eventCount,
const VkEvent* pEvents, VkPipelineStageFlags
srcStageMask,
VkPipelineStageFlags dstStageMask, uint32_t
memoryBarrierCount,
const VkMemoryBarrier* pMemoryBarriers, uint32_t
...
VK_LAYER_EXPORT VKAPI_ATTR
void VKAPI_CALL
vkCmdDebugMarkerBeginEXT(VkCommandBuffer
commandBuffer,
VkDebugMarkerMarkerInfoEXT* pMarkerInfo
)
{
...
VK_LAYER_EXPORT VKAPI_ATTR
void VKAPI_CALL
vkCmdDebugMarkerEndEXT(VkCommandBuffer
commandBuffer)
{
device_dispatch_table(commandBuffer)
->
...
VK_LAYER_EXPORT VKAPI_ATTR
void VKAPI_CALL
vkCmdSetDepthBias(VkCommandBuffer
commandBuffer,
...
VK_LAYER_EXPORT VKAPI_ATTR
void VKAPI_CALL
vkDestroyObjectTableNVX(VkDevice
device,
...
VK_LAYER_EXPORT VKAPI_ATTR
void VKAPI_CALL
vkDestroyPipelineCache(VkDevice
device,
...
VK_LAYER_EXPORT VKAPI_ATTR
void VKAPI_CALL
vkCmdSetBlendConstants(VkCommandBuffer
commandBuffer,
...
VK_LAYER_EXPORT VKAPI_ATTR
void VKAPI_CALL
vkCmdSetDepthBounds(VkCommandBuffer
commandBuffer,
...
dstStageMask,
VkDependencyFlags dependencyFlags, uint32_t
memoryBarrierCount,
const VkMemoryBarrier* pMemoryBarriers, uint32_t
bufferMemoryBarrierCount,
const VkBufferMemoryBarrier* pBufferMemoryBarriers, uint32_t
...
VK_LAYER_EXPORT VKAPI_ATTR
void VKAPI_CALL
vkCmdSetStencilCompareMask(VkCommandBuffer
commandBuffer,
...
device,
VkImage image,
const VkImageSubresource* pSubresource, VkSubresourceLayout
* pLayout)
{
device_dispatch_table(device)
->
...
VK_LAYER_EXPORT VKAPI_ATTR
void VKAPI_CALL
vkCmdSetStencilWriteMask(VkCommandBuffer
commandBuffer,
VkStencilFaceFlags faceMask, uint32_t
writeMask)
{
...
VK_LAYER_EXPORT VKAPI_ATTR
void VKAPI_CALL
vkCmdSetStencilReference(VkCommandBuffer
commandBuffer,
VkStencilFaceFlags faceMask, uint32_t
reference)
{
...
commandBuffer,
VkPipelineBindPoint pipelineBindPoint, VkPipelineLayout
layout,
...
VK_LAYER_EXPORT VKAPI_ATTR
void VKAPI_CALL
vkCmdBeginQuery(VkCommandBuffer
commandBuffer,
VkQueryPool queryPool, uint32_t
query,
VkQueryControlFlags flags
...
<PFN_vkVoidFunction>(vkGetPhysicalDeviceFormatProperties);
if(
strcmp(pName,
"vkGetPhysicalDeviceImageFormatProperties") == 0)
return reinterpret_cast
<PFN_vkVoidFunction>(vkGetPhysicalDeviceImageFormatProperties);
if(
strcmp(pName,
"vkEnumerateDeviceLayerProperties") == 0)
return reinterpret_cast
<PFN_vkVoidFunction>(vkEnumerateDeviceLayerProperties);
if(
strcmp(pName,
...
return reinterpret_cast
<PFN_vkVoidFunction>(vkGetPhysicalDeviceQueueFamilyProperties);
if(
strcmp(pName,
"vkCreateDevice") == 0)
return reinterpret_cast
...
return reinterpret_cast
<PFN_vkVoidFunction>(vkGetPhysicalDeviceImageFormatProperties2KHR);
if(
strcmp(pName,
...
return reinterpret_cast
<PFN_vkVoidFunction>(vkGetPhysicalDeviceSurfaceCapabilities2EXT);
if(
strcmp(pName,
"vkGetPhysicalDeviceQueueFamilyProperties2KHR") == 0)
return reinterpret_cast
<PFN_vkVoidFunction>(vkGetPhysicalDeviceQueueFamilyProperties2KHR);
if(
strcmp(pName,
"vkGetPhysicalDeviceSparseImageFormatProperties2KHR") == 0)
return reinterpret_cast
<PFN_vkVoidFunction>(vkGetPhysicalDeviceSparseImageFormatProperties2KHR);
if(
strcmp(pName,
"vkGetPhysicalDeviceMemoryProperties2KHR") == 0)
return reinterpret_cast
<PFN_vkVoidFunction>(vkGetPhysicalDeviceMemoryProperties2KHR);
#if defined(VK_USE_PLATFORM_WIN32_KHR)
...
return reinterpret_cast
<PFN_vkVoidFunction>(vkGetDisplayPlaneSupportedDisplaysKHR);
#if defined(VK_USE_PLATFORM_VI_NN)
...
return reinterpret_cast
<PFN_vkVoidFunction>(vkCreateDisplayModeKHR);
#if defined(VK_USE_PLATFORM_XCB_KHR)
...
return reinterpret_cast
<PFN_vkVoidFunction>(vkDestroySurfaceKHR);
if(
strcmp(pName,
"vkGetPhysicalDeviceSurfaceSupportKHR") == 0)
return reinterpret_cast
<PFN_vkVoidFunction>(vkGetPhysicalDeviceSurfaceSupportKHR);
if(
strcmp(pName,
"vkDestroyDebugReportCallbackEXT") == 0)
return reinterpret_cast
<PFN_vkVoidFunction>(vkDestroyDebugReportCallbackEXT);
if(
strcmp(pName,
"vkGetPhysicalDeviceSurfaceFormatsKHR") == 0)
return reinterpret_cast
<PFN_vkVoidFunction>(vkGetPhysicalDeviceSurfaceFormatsKHR);
#if defined(VK_USE_PLATFORM_XLIB_KHR)
...
return reinterpret_cast
<PFN_vkVoidFunction>(vkDebugReportMessageEXT);
#if defined(VK_USE_PLATFORM_XLIB_KHR)
...
return reinterpret_cast
<PFN_vkVoidFunction>(vkGetPhysicalDeviceGeneratedCommandsPropertiesNVX);
if(
strcmp(pName,
...
return reinterpret_cast
<PFN_vkVoidFunction>(vkGetPhysicalDeviceExternalImageFormatPropertiesNV);
if(
strcmp(pName,
...
return reinterpret_cast
<PFN_vkVoidFunction>(vkGetPhysicalDeviceFeatures);
if(
strcmp(pName,
...
return reinterpret_cast
<PFN_vkVoidFunction>(vkGetPhysicalDeviceSurfacePresentModesKHR);
if(
strcmp(pName,
"vkGetPhysicalDeviceProperties2KHR") == 0)
return reinterpret_cast
<PFN_vkVoidFunction>(vkGetPhysicalDeviceProperties2KHR);
#if defined(VK_USE_PLATFORM_XLIB_XRANDR_EXT)
...
return reinterpret_cast
<PFN_vkVoidFunction>(vkGetPhysicalDeviceFormatProperties2KHR);
...
return reinterpret_cast
<PFN_vkVoidFunction>(vkCmdBindVertexBuffers);
if(
strcmp(pName,
"vkCmdDraw") == 0)
return reinterpret_cast
...
return reinterpret_cast
<PFN_vkVoidFunction>(vkCreateDescriptorSetLayout);
if(
strcmp(pName,
"vkDestroyFramebuffer") == 0)
return reinterpret_cast
<PFN_vkVoidFunction>(vkDestroyFramebuffer);
if(
strcmp(pName,
"vkCreateComputePipelines") == 0)
return reinterpret_cast
<PFN_vkVoidFunction>(vkCreateComputePipelines);
if(
strcmp(pName,
"vkCmdDrawIndexed") == 0)
return reinterpret_cast
<PFN_vkVoidFunction>(vkCmdDrawIndexed);
if(
strcmp(pName,
"vkCreateRenderPass") == 0)
return reinterpret_cast
<PFN_vkVoidFunction>(vkCreateRenderPass);
if(
strcmp(pName,
"vkCmdDrawIndirect") == 0)
return reinterpret_cast
<PFN_vkVoidFunction>(vkCmdDrawIndirect);
if(
strcmp(pName,
"vkCmdDrawIndexedIndirect") == 0)
return reinterpret_cast
<PFN_vkVoidFunction>(vkCmdDrawIndexedIndirect);
if(
strcmp(pName,
"vkGetDeviceQueue") == 0)
return reinterpret_cast
<PFN_vkVoidFunction>(vkGetDeviceQueue);
if(
strcmp(pName,
"vkQueueSubmit") == 0)
return reinterpret_cast
...
"vkCmdDispatch") == 0)
return reinterpret_cast
<PFN_vkVoidFunction>(vkCmdDispatch);
if(
strcmp(pName,
"vkCmdDispatchIndirect") == 0)
return reinterpret_cast
<PFN_vkVoidFunction>(vkCmdDispatchIndirect);
if(
strcmp(pName,
"vkDestroyPipeline") == 0)
return reinterpret_cast
<PFN_vkVoidFunction>(vkDestroyPipeline);
if(
strcmp(pName,
"vkCmdCopyBuffer") == 0)
return reinterpret_cast
...
"vkCmdCopyImage") == 0)
return reinterpret_cast
<PFN_vkVoidFunction>(vkCmdCopyImage);
if(
strcmp(pName,
...
"vkCmdBlitImage") == 0)
return reinterpret_cast
<PFN_vkVoidFunction>(vkCmdBlitImage);
if(
strcmp(pName,
"vkDestroyPipelineLayout") == 0)
return reinterpret_cast
<PFN_vkVoidFunction>(vkDestroyPipelineLayout);
if(
strcmp(pName,
"vkQueueWaitIdle") == 0)
return reinterpret_cast
<PFN_vkVoidFunction>(vkQueueWaitIdle);
if(
strcmp(pName,
"vkDeviceWaitIdle") == 0)
return reinterpret_cast
<PFN_vkVoidFunction>(vkDeviceWaitIdle);
if(
strcmp(pName,
...
"vkCreateSampler") == 0)
return reinterpret_cast
<PFN_vkVoidFunction>(vkCreateSampler);
if(
strcmp(pName,
"vkCmdCopyBufferToImage") == 0)
return reinterpret_cast
<PFN_vkVoidFunction>(vkCmdCopyBufferToImage);
if(
strcmp(pName,
...
"vkDestroyDevice") == 0)
return reinterpret_cast
<PFN_vkVoidFunction>(vkDestroyDevice);
if(
strcmp(pName,
...
return reinterpret_cast
<PFN_vkVoidFunction>(vkCmdCopyImageToBuffer);
if(
strcmp(pName,
...
"vkCmdUpdateBuffer") == 0)
return reinterpret_cast
<PFN_vkVoidFunction>(vkCmdUpdateBuffer);
if(
strcmp(pName,
"vkCmdFillBuffer") == 0)
return reinterpret_cast
<PFN_vkVoidFunction>(vkCmdFillBuffer);
if(
strcmp(pName,
"vkCreateBuffer") == 0)
return reinterpret_cast
...
return reinterpret_cast
<PFN_vkVoidFunction>(vkGetDeviceMemoryCommitment);
if(
strcmp(pName,
"vkDestroyCommandPool") == 0)
return reinterpret_cast
<PFN_vkVoidFunction>(vkDestroyCommandPool);
if(
strcmp(pName,
"vkCmdClearColorImage") == 0)
return reinterpret_cast
<PFN_vkVoidFunction>(vkCmdClearColorImage);
if(
strcmp(pName,
"vkResetCommandPool") == 0)
return reinterpret_cast
<PFN_vkVoidFunction>(vkResetCommandPool);
if(
strcmp(pName,
...
return reinterpret_cast
<PFN_vkVoidFunction>(vkCmdResetQueryPool);
if(
strcmp(pName,
"vkDestroySampler") == 0)
return reinterpret_cast
<PFN_vkVoidFunction>(vkDestroySampler);
if(
strcmp(pName,
"vkBindImageMemory") == 0)
return reinterpret_cast
...
return reinterpret_cast
<PFN_vkVoidFunction>(vkCreateDescriptorPool);
if(
strcmp(pName,
"vkDestroyFence") == 0)
return reinterpret_cast
<PFN_vkVoidFunction>(vkDestroyFence);
if(
strcmp(pName,
...
return reinterpret_cast
<PFN_vkVoidFunction>(vkCmdClearDepthStencilImage);
if(
strcmp(pName,
...
return reinterpret_cast
<PFN_vkVoidFunction>(vkCmdWriteTimestamp);
if(
strcmp(pName,
...
return reinterpret_cast
<PFN_vkVoidFunction>(vkFreeCommandBuffers);
if(
strcmp(pName,
...
return reinterpret_cast
<PFN_vkVoidFunction>(vkCmdPushConstants);
if(
strcmp(pName,
"vkCmdCopyQueryPoolResults") == 0)
return reinterpret_cast
<PFN_vkVoidFunction>(vkCmdCopyQueryPoolResults);
if(
strcmp(pName,
"vkResetFences") == 0)
return reinterpret_cast
<PFN_vkVoidFunction>(vkResetFences);
if(
strcmp(pName,
...
"vkGetFenceStatus") == 0)
return reinterpret_cast
<PFN_vkVoidFunction>(vkGetFenceStatus);
if(
strcmp(pName,
...
"vkWaitForFences") == 0)
return reinterpret_cast
<PFN_vkVoidFunction>(vkWaitForFences);
if(
strcmp(pName,
"vkGetImageSparseMemoryRequirements") == 0)
return reinterpret_cast
<PFN_vkVoidFunction>(vkGetImageSparseMemoryRequirements);
if(
strcmp(pName,
"vkCreateSemaphore") == 0)
return reinterpret_cast
<PFN_vkVoidFunction>(vkCreateSemaphore);
if(
strcmp(pName,
"vkCmdBeginRenderPass") == 0)
return reinterpret_cast
<PFN_vkVoidFunction>(vkCmdBeginRenderPass);
if(
strcmp(pName,
"vkEndCommandBuffer") == 0)
return reinterpret_cast
<PFN_vkVoidFunction>(vkEndCommandBuffer);
if(
strcmp(pName,
"vkDestroySemaphore") == 0)
return reinterpret_cast
<PFN_vkVoidFunction>(vkDestroySemaphore);
if(
strcmp(pName,
"vkDestroyImageView") == 0)
return reinterpret_cast
<PFN_vkVoidFunction>(vkDestroyImageView);
if(
strcmp(pName,
...
return reinterpret_cast
<PFN_vkVoidFunction>(vkDisplayPowerControlEXT);
if(
strcmp(pName,
"vkCmdResolveImage") == 0)
return reinterpret_cast
<PFN_vkVoidFunction>(vkCmdResolveImage);
if(
strcmp(pName,
"vkCreateBufferView") == 0)
return reinterpret_cast
<PFN_vkVoidFunction>(vkCreateBufferView);
if(
strcmp(pName,
"vkRegisterDeviceEventEXT") == 0)
return reinterpret_cast
<PFN_vkVoidFunction>(vkRegisterDeviceEventEXT);
if(
strcmp(pName,
"vkCmdNextSubpass") == 0)
return reinterpret_cast
<PFN_vkVoidFunction>(vkCmdNextSubpass);
if(
strcmp(pName,
"vkCmdDrawIndirectCountAMD") == 0)
return reinterpret_cast
<PFN_vkVoidFunction>(vkCmdDrawIndirectCountAMD);
if(
strcmp(pName,
"vkQueuePresentKHR") == 0)
return reinterpret_cast
<PFN_vkVoidFunction>(vkQueuePresentKHR);
if(
strcmp(pName,
"vkTrimCommandPoolKHR") == 0)
return reinterpret_cast
<PFN_vkVoidFunction>(vkTrimCommandPoolKHR);
if(
strcmp(pName,
"vkCmdSetEvent") == 0)
return reinterpret_cast
<PFN_vkVoidFunction>(vkCmdSetEvent);
if(
strcmp(pName,
"vkRegisterDisplayEventEXT") == 0)
return reinterpret_cast
<PFN_vkVoidFunction>(vkRegisterDisplayEventEXT);
if(
strcmp(pName,
"vkCreateEvent") == 0)
return reinterpret_cast
<PFN_vkVoidFunction>(vkCreateEvent);
if(
strcmp(pName,
"vkGetSwapchainCounterEXT") == 0)
return reinterpret_cast
<PFN_vkVoidFunction>(vkGetSwapchainCounterEXT);
if(
strcmp(pName,
"vkCmdDrawIndexedIndirectCountAMD") == 0)
return reinterpret_cast
<PFN_vkVoidFunction>(vkCmdDrawIndexedIndirectCountAMD);
if(
strcmp(pName,
"vkDestroyDescriptorPool") == 0)
return reinterpret_cast
<PFN_vkVoidFunction>(vkDestroyDescriptorPool);
if(
strcmp(pName,
"vkCmdProcessCommandsNVX") == 0)
return reinterpret_cast
<PFN_vkVoidFunction>(vkCmdProcessCommandsNVX);
if(
strcmp(pName,
"vkDestroyShaderModule") == 0)
return reinterpret_cast
<PFN_vkVoidFunction>(vkDestroyShaderModule);
if(
strcmp(pName,
"vkCmdEndRenderPass") == 0)
return reinterpret_cast
<PFN_vkVoidFunction>(vkCmdEndRenderPass);
if(
strcmp(pName,
"vkCmdExecuteCommands") == 0)
return reinterpret_cast
<PFN_vkVoidFunction>(vkCmdExecuteCommands);
if(
strcmp(pName,
"vkDebugMarkerSetObjectTagEXT") == 0)
return reinterpret_cast
<PFN_vkVoidFunction>(vkDebugMarkerSetObjectTagEXT);
if(
strcmp(pName,
"vkQueueBindSparse") == 0)
return reinterpret_cast
<PFN_vkVoidFunction>(vkQueueBindSparse);
if(
strcmp(pName,
"vkCreatePipelineCache") == 0)
return reinterpret_cast
<PFN_vkVoidFunction>(vkCreatePipelineCache);
if(
strcmp(pName,
"vkDestroyEvent") == 0)
return reinterpret_cast
<PFN_vkVoidFunction>(vkDestroyEvent);
if(
strcmp(pName,
"vkDestroyBufferView") == 0)
return reinterpret_cast
<PFN_vkVoidFunction>(vkDestroyBufferView);
if(
strcmp(pName,
"vkResetDescriptorPool") == 0)
return reinterpret_cast
<PFN_vkVoidFunction>(vkResetDescriptorPool);
if(
strcmp(pName,
"vkAllocateDescriptorSets") == 0)
return reinterpret_cast
<PFN_vkVoidFunction>(vkAllocateDescriptorSets);
if(
strcmp(pName,
"vkResetCommandBuffer") == 0)
return reinterpret_cast
<PFN_vkVoidFunction>(vkResetCommandBuffer);
if(
strcmp(pName,
"vkCmdBindPipeline") == 0)
return reinterpret_cast
...
return reinterpret_cast
<PFN_vkVoidFunction>(vkCmdReserveSpaceForCommandsNVX);
if(
strcmp(pName,
"vkSetEvent") == 0)
return reinterpret_cast
<PFN_vkVoidFunction>(vkSetEvent);
if(
strcmp(pName,
"vkCreateImage") == 0)
return reinterpret_cast
...
"vkCmdSetViewport") == 0)
return reinterpret_cast
<PFN_vkVoidFunction>(vkCmdSetViewport);
if(
strcmp(pName,
"vkDebugMarkerSetObjectNameEXT") == 0)
return reinterpret_cast
<PFN_vkVoidFunction>(vkDebugMarkerSetObjectNameEXT);
if(
strcmp(pName,
"vkGetEventStatus") == 0)
return reinterpret_cast
<PFN_vkVoidFunction>(vkGetEventStatus);
if(
strcmp(pName,
"vkCmdResetEvent") == 0)
return reinterpret_cast
<PFN_vkVoidFunction>(vkCmdResetEvent);
if(
strcmp(pName,
"vkCreateIndirectCommandsLayoutNVX") == 0)
return reinterpret_cast
<PFN_vkVoidFunction>(vkCreateIndirectCommandsLayoutNVX);
if(
strcmp(pName,
"vkCmdSetLineWidth") == 0)
return reinterpret_cast
<PFN_vkVoidFunction>(vkCmdSetLineWidth);
if(
strcmp(pName,
"vkCmdWaitEvents") == 0)
return reinterpret_cast
<PFN_vkVoidFunction>(vkCmdWaitEvents);
if(
strcmp(pName,
"vkDestroyImage") == 0)
return reinterpret_cast
...
return reinterpret_cast
<PFN_vkVoidFunction>(vkCmdDebugMarkerBeginEXT);
if(
strcmp(pName,
"vkCmdSetScissor") == 0)
return reinterpret_cast
<PFN_vkVoidFunction>(vkCmdSetScissor);
if(
strcmp(pName,
"vkCreateSharedSwapchainsKHR") == 0)
return reinterpret_cast
<PFN_vkVoidFunction>(vkCreateSharedSwapchainsKHR);
if(
strcmp(pName,
"vkCmdDebugMarkerEndEXT") == 0)
return reinterpret_cast
<PFN_vkVoidFunction>(vkCmdDebugMarkerEndEXT);
if(
strcmp(pName,
"vkDestroyIndirectCommandsLayoutNVX") == 0)
return reinterpret_cast
<PFN_vkVoidFunction>(vkDestroyIndirectCommandsLayoutNVX);
if(
strcmp(pName,
"vkCmdSetDepthBias") == 0)
return reinterpret_cast
...
return reinterpret_cast
<PFN_vkVoidFunction>(vkDestroyObjectTableNVX);
if(
strcmp(pName,
"vkResetEvent") == 0)
return reinterpret_cast
<PFN_vkVoidFunction>(vkResetEvent);
if(
strcmp(pName,
"vkDestroyPipelineCache") == 0)
return reinterpret_cast
<PFN_vkVoidFunction>(vkDestroyPipelineCache);
if(
strcmp(pName,
"vkCmdDebugMarkerInsertEXT") == 0)
return reinterpret_cast
<PFN_vkVoidFunction>(vkCmdDebugMarkerInsertEXT);
if(
strcmp(pName,
"vkCreateObjectTableNVX") == 0)
return reinterpret_cast
<PFN_vkVoidFunction>(vkCreateObjectTableNVX);
if(
strcmp(pName,
...
"vkCreateQueryPool") == 0)
return reinterpret_cast
<PFN_vkVoidFunction>(vkCreateQueryPool);
if(
strcmp(pName,
"vkGetPipelineCacheData") == 0)
return reinterpret_cast
<PFN_vkVoidFunction>(vkGetPipelineCacheData);
if(
strcmp(pName,
"vkUpdateDescriptorSets") == 0)
return reinterpret_cast
<PFN_vkVoidFunction>(vkUpdateDescriptorSets);
if(
strcmp(pName,
"vkUnregisterObjectsNVX") == 0)
return reinterpret_cast
<PFN_vkVoidFunction>(vkUnregisterObjectsNVX);
if(
strcmp(pName,
"vkMergePipelineCaches") == 0)
return reinterpret_cast
<PFN_vkVoidFunction>(vkMergePipelineCaches);
if(
strcmp(pName,
"vkRegisterObjectsNVX") == 0)
return reinterpret_cast
<PFN_vkVoidFunction>(vkRegisterObjectsNVX);
if(
strcmp(pName,
"vkCmdSetBlendConstants") == 0)
return reinterpret_cast
<PFN_vkVoidFunction>(vkCmdSetBlendConstants);
if(
strcmp(pName,
...
return reinterpret_cast
<PFN_vkVoidFunction>(vkCmdSetDepthBounds);
if(
strcmp(pName,
...
return reinterpret_cast
<PFN_vkVoidFunction>(vkCmdPipelineBarrier);
if(
strcmp(pName,
"vkCmdSetStencilCompareMask") == 0)
return reinterpret_cast
<PFN_vkVoidFunction>(vkCmdSetStencilCompareMask);
if(
strcmp(pName,
"vkCreateFence") == 0)
return reinterpret_cast
<PFN_vkVoidFunction>(vkCreateFence);
if(
strcmp(pName,
"vkDestroyQueryPool") == 0)
return reinterpret_cast
<PFN_vkVoidFunction>(vkDestroyQueryPool);
if(
strcmp(pName,
"vkGetImageSubresourceLayout") == 0)
return reinterpret_cast
<PFN_vkVoidFunction>(vkGetImageSubresourceLayout);
if(
strcmp(pName,
"vkCreateImageView") == 0)
return reinterpret_cast
<PFN_vkVoidFunction>(vkCreateImageView);
if(
strcmp(pName,
"vkCmdSetStencilWriteMask") == 0)
return reinterpret_cast
<PFN_vkVoidFunction>(vkCmdSetStencilWriteMask);
if(
strcmp(pName,
"vkCreateFramebuffer") == 0)
return reinterpret_cast
<PFN_vkVoidFunction>(vkCreateFramebuffer);
if(
strcmp(pName,
"vkDestroySwapchainKHR") == 0)
return reinterpret_cast
<PFN_vkVoidFunction>(vkDestroySwapchainKHR);
if(
strcmp(pName,
...
return reinterpret_cast
<PFN_vkVoidFunction>(vkGetQueryPoolResults);
if(
strcmp(pName,
"vkCmdBindDescriptorSets") == 0)
return reinterpret_cast
<PFN_vkVoidFunction>(vkCmdBindDescriptorSets);
if(
strcmp(pName,
"vkCmdBindIndexBuffer") == 0)
return reinterpret_cast
<PFN_vkVoidFunction>(vkCmdBindIndexBuffer);
if(
strcmp(pName,
"vkCmdBeginQuery") == 0)
return reinterpret_cast
<PFN_vkVoidFunction>(vkCmdBeginQuery);
